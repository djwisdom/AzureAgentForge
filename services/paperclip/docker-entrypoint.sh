...
# Routes all model requests through the model router sidecar on ca-agent-runtime,
...
echo "[entrypoint] Wrote Hermes config at ${HERMES_CONFIG} (base_url=${OPENAI_BASE_URL:-http://ca-agent-runtime/v1})"
